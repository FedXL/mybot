...
def extract_money(login_value, password_value):
    ...
    try:
        ...
        try:
            ...
            logging.debug("[INFO] success element witch tell us that we cant to login is not found, so we are login ... ok")
...
if __name__ == "__main__":
    extract_money("mihailhoroshavin@mail.ru", "Password_123")
